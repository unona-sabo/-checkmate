...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::prefix('projects/{project}')->name('checklists.')->group(function () {
        ...
        Route::post('checklists/import-csv', [ChecklistController::class, 'importCsvToNewChecklist'])->name('import-csv-new-checklist');
    ...
    Route::prefix('projects/{project}')->name('bugreports.')->group(function () {
        ...
        Route::delete('bugreports/{bugreport}/link-clickup', [BugreportController::class, 'unlinkClickUp'])->name('unlink-clickup');
