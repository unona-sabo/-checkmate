...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'AI Generator',
        href: `/projects/${props.project.id}/ai-generator`,
    },
];
...
const approvedCases = computed(() =>
    generatedCases.value.filter((c) => c.approved),
);
...
async function sendGenerateRequest(formData: FormData) {
    const response = await fetch(
        `/projects/${props.project.id}/ai-generator/generate`,
        {
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN':
...
async function generate() {
    ...
    try {
        ...
        generatedCases.value = (data.test_cases || []).map(
...
function toggleApproval(index: number) {
    generatedCases.value[index].approved =
        !generatedCases.value[index].approved;
}
...
function importCases() {
    ...
    const payload: Record<string, unknown> = {
        test_cases: approvedCases.value.map(
            ({
                title,
                description,
                preconditions,
                    ...
                    <Card>
                        ...
                        <CardContent class="space-y-6">
                            ...
                            <div v-if="activeTab === 'file'">
                                ...
                                <div
                                    v-else
                                    class="mt-1.5 flex items-center justify-between rounded-lg border p-4"
                                >
                                    <div class="flex items-center gap-3">
                                        <FileText
                            ...
                            <div v-if="activeTab === 'image'">
                                ...
                                >
                                    ...
                                    <div class="text-center">
                                        ...
                                        <div
                                            class="mt-2 flex items-center justify-center gap-1.5 text-xs text-muted-foreground"
                                        >
...
- Cover internationalization scenarios"
                                ...
                                <p class="mt-1 text-xs text-muted-foreground">
                                    Optional. Customize what the AI focuses on
                                    ...
                                    <Select v-model="language">
                                        ...
                                        <SelectContent>
                                            ...
                                            <SelectItem value="English"
                                                >English</SelectItem
                                            >
                                            <SelectItem value="Українська"
                                                >Українська</SelectItem
                                            >
                                        </SelectContent>
                                    </Select>
                                </div>
                ...
                <div class="flex flex-col gap-4">
                    ...
                    >
                        <CardContent class="py-16 text-center">
                            ...
                            <p class="mt-1 text-sm text-muted-foreground/70">
                                Provide input on the left and click Generate to
                                get started.
                            </p>
                        </CardContent>
                    </Card>
                    ...
                    >
                        <CardContent class="py-16 text-center">
                            <Loader2
                                class="mx-auto mb-4 h-12 w-12 animate-spin text-purple-500"
                            />
                            <p class="text-lg font-medium">
                                Generating test cases...
                            </p>
                            <p class="mt-1 text-sm text-muted-foreground">
                                This may take a moment depending on the input
                                size.
                            </p>
                        </CardContent>
                    </Card>
                    ...
                    <template v-if="generatedCases.length > 0 && !isGenerating">
                        ...
                        >
                            <CardContent class="py-4">
                                <Label class="text-blue-900 dark:text-blue-300"
                                    >Not satisfied? Refine the results</Label
                                >
                                <Textarea
                        ...
                        <RestrictedAction>
                            ...
                            >
                                ...
                                {{
                                    isImporting
                                        ? 'Importing...'
                                        : `Import ${approvedCases.length} Test Case${approvedCases.length !== 1 ? 's' : ''}`
                                }}
                            </Button>
                        </RestrictedAction>
                    </template>
