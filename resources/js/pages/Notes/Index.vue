...
const deleteNote = () => {
    ...
    router.delete(
        `/projects/${props.project.id}/notes/${noteToDelete.value.id}`,
        {
            onSuccess: () => {
        ...
        <div class="flex h-full flex-1 flex-col gap-6 p-6">
            ...
            >
                <div class="text-center">
                    ...
                    <RestrictedAction>
                        <Link
                            :href="`/projects/${project.id}/notes/create`"
            ...
            >
                ...
                <p
                    class="max-w-full truncate px-4 text-sm text-muted-foreground"
                >
            ...
            <div v-else class="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                ...
                >
                    <Card
                        class="flex h-full cursor-pointer flex-col transition-colors hover:border-primary"
                    >
                        <CardHeader class="pb-2">
                            <div class="flex items-start justify-between">
                                ...
                                >
                                    <StickyNote
                                        class="mt-0.5 h-4 w-4 shrink-0 text-yellow-500"
                                    />
                                    <span
                                        v-html="
                                            highlight(
                                ...
                                <Badge
                                    :variant="
                                        note.is_draft ? 'secondary' : 'default'
                                    "
                                >
                        ...
                        <CardContent class="flex flex-1 flex-col">
                            <p
                                ...
                                v-html="
                                    highlight(truncateContent(note.content))
                                "
                            />
                            <p
                                v-else
                                class="mb-3 text-sm text-muted-foreground italic"
                            >
                                No content yet
                            </p>

                            <div
                                v-if="note.documentation"
