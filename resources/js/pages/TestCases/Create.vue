...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    },
    {
        ...
        href: `/projects/${props.project.id}/test-suites/${props.testSuite.id}/test-cases/create`,
    },
];
...
const submit = () => {
    form.post(
        `/projects/${props.project.id}/test-suites/${props.testSuite.id}/test-cases`,
        {
            forceFormData: true,
        },
    );
                ...
                <Card>
                    ...
                    <CardContent>
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div
                                v-if="bugreportAttachments?.length"
                                class="space-y-2"
                            >
                                ...
                                <p class="text-xs text-muted-foreground">
                                    These files will be copied to the new test
                                    case.
                                </p>
                                <div class="space-y-2">
                                    <div
                                        v-for="attachment in bugreportAttachments"
                                        :key="attachment.id"
