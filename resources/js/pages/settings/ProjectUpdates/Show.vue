...
const breadcrumbs: BreadcrumbItem[] = [
    { title: 'Project Updates', href: '/settings/project-updates' },
    {
        ...
        href: `/settings/project-updates/${props.section.key}`,
    },
];
...
function saveFeature(feature: SectionFeature): void {
    saving.value = true;
    router.put(
        `/settings/project-updates/${props.section.key}/features/${feature.id}`,
        {
...
function createFeature(): void {
    creating.value = true;
    router.post(
        `/settings/project-updates/${props.section.key}/features`,
        {
...
function deleteFeature(): void {
    ...
    router.delete(
        `/settings/project-updates/${props.section.key}/features/${featureToDelete.value.id}`,
        {
            preserveScroll: true,
            onFinish: () => {
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <SettingsLayout wide>
            <div class="flex flex-col gap-6">
                ...
                <div class="rounded-xl border border-border bg-card p-6">
                    ...
                    >
                        ...
                        <span class="inline-flex items-center gap-1.5">
                            ...
                            Updated:
                            {{ formatDateTime(section.latest_updated_at) }}
                        </span>
                        <span class="inline-flex items-center gap-1.5">
                ...
                <div
                    v-if="showNewForm"
                    class="rounded-lg border border-primary/30 bg-card p-4"
                >
