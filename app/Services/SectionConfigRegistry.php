        ...
        return [
            'checklists' => [
                ...
                'features' => [
                    ...
                    'Create a brand-new checklist directly from pasted notes',
                    ...
                    'Keyboard shortcuts hint tooltip next to the Actions menu while rows are selected',
                    'Create a brand-new checklist directly from an imported CSV file',
                ],
            ...
            'test-suites' => [
                ...
                'features' => [
                    ...
                    'Paste or drag-and-drop screenshots directly into the attachment dropzone',
                    'Notes per test case',
                    ...
                    'Paste AI-generated test case text in any format for automatic parsing into test cases',
                    'Archive test cases into one or more dedicated archive suites, individually or in bulk',
                    'Unarchive test cases back to their original suite or a chosen suite',
                    'Create a brand-new test suite directly from pasted notes or CSV/Excel import',
                ],
            ...
            'bugreports' => [
                ...
                'features' => [
                    ...
                    'Filter bug reports by linked feature on index page',
                    'Bulk "Sync from ClickUp" action to refresh all linked bug report statuses at once',
                ],
            ...
            'test-coverage' => [
                ...
                'features' => [
                    ...
                    'AI-powered coverage analysis with a per-workspace choice of Gemini, Claude, or OpenAI',
                    'Automated coverage gap detection and prioritization',
                    'AI-generated test case suggestions for uncovered features, using the feature\'s existing test cases and linked documentation as context',
                    'Select generated test cases and approve them into a new or existing test suite',
                    ...
                    'Coverage/gap diffing between consecutive analysis runs, with added/resolved gaps called out',
                    'Browse a past history entry\'s full AI report read-only, without affecting the project\'s current analysis',
                    'History auto-refreshes after a new analysis run, without a page reload',
                    'Readable error messages when the AI provider call fails, instead of failing silently',
                    'Refuses to run AI analysis on a project with no features, instead of fabricating a fake report',
                    'Prompt size kept under AI context limits on large projects by dropping step detail and capping documentation length',
            ...
            'balance-calculator' => [
                ...
                'description' => 'Financial balance calculator for tracking and projecting fund repayments across Active Funds and Active Funds XL with priority-based income allocation.',
                'features' => [
                    'Active Funds and Active Funds XL tabs',
                    'Four-block layout: Current Balance, Balance After Income, Repayment Priority, Results',
                    'Approved Funds, Advanced Funds, and Active Funds balance tracking',
                    'Frozen Funds field for Active Funds tab advanced balance adjustment',
                    'Priority-based income repayment loop: Commission, Overspending, Debt Body, Advanced Used',
                    'Cascade overflow repayment: commission surplus redirects to debt and vice versa',
                    'Factor Rate and Repayment Percentage inputs (XL only) for automatic commission/debt split',
                    'Auto-calculated blocked advanced funds as a percentage of Advanced Funds Income (XL)',
                    'Overspending excluded from repayment priority in Active Funds XL tab',
                    'Advanced Funds Income field (XL) with separate income allocation — does not top up Approved',
                    'Advanced Total formula: Available + Income − Used − Blocked (XL) or Frozen (Active)',
                    'Grand Total = Approved Funds + Advanced Total + Active Available',
                    'localStorage persistence for all calculator fields — no reset on page reload',
                    'Accrual History tab with per-partner calculation records',
                    'Save and continue accrual history records with partner ID and tab type',
                    'History preview shows Advanced Total and Grand Total per partner record',
                ],
            ],
            'documentations' => [
                'key' => 'documentations',
                ...
                'features' => [
                    ...
                    'Linked features shown as badges on the documentation page itself',
                ],
